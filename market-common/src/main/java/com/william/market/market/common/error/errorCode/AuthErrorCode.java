package com.william.market.market.common.error.errorCode;


import com.william.common.error.errorCode.basics.IErrorCodeEnum;

public enum AuthErrorCode  implements IErrorCodeEnum {
	...
	AuthErrorCode(String errorCode, String errorMsg) {
